...
TIME_BASED = [
    ReminderEntry(
        ...
        "time_based", "Sahih Muslim 854", ("friday",),
    ),
    ReminderEntry(
        ...
        "time_based", "Sunan Abi Dawud 1047", ("friday", "salawat"),
    ),
    ReminderEntry(
        ...
        "time_based", "Al-Bayhaqi 6010", ("friday", "kahf"),
    ),
    ReminderEntry(
        ...
        "time_based", "Sahih al-Bukhari 935", ("friday", "dua"),
    ),
    ReminderEntry(
        ...
        "time_based", "Sahih al-Bukhari 1145", ("night", "tahajjud", "dua"),
    ),
    ReminderEntry(
        "The fasting day",
        ...
        "time_based", "Sahih Muslim 1153", ("fasting",),
    ),
    ReminderEntry(
        ...
        "time_based", "Jami at-Tirmidhi 747", ("fasting",),
    ),
    ReminderEntry(
        "The white days",
        ...
        "time_based", "Sunan an-Nasa'i 2419", ("fasting",),
    ),
    ReminderEntry(
        "A Ramadan mindset",
