...
HEREAFTER = [
    ReminderEntry(
        ...
        "hereafter", "Jami at-Tirmidhi 2307", ("death", "accountability"),
    ),
    ReminderEntry(
        ...
        "hereafter", "Jami at-Tirmidhi 2308", ("grave", "hereafter"),
    ),
    ReminderEntry(
        ...
        "hereafter", "Sahih al-Bukhari 6406", ("scales", "accountability"),
    ),
    ReminderEntry(
        ...
        "hereafter", "Sahih al-Bukhari 6024", ("preparation", "accountability"),
    ),
    ReminderEntry(
        ...
        "hereafter", "Sahih Muslim 2822", ("jannah", "trials"),
    ),
    ReminderEntry(
        "A glimpse of Jannah",
        ...
        "hereafter", "Sahih Muslim 2824", ("jannah", "hope"),
    ),
    ReminderEntry(
        ...
        "hereafter", "Sahih al-Bukhari 6018", ("accountability", "speech"),
    ),
    ReminderEntry(
        ...
        "hereafter", "Quran 99:7-8", ("accountability", "deeds"),
    ),
    ReminderEntry(
        ...
        "hereafter", "Sahih Muslim 2816", ("mercy", "jannah"),
    ),
    ReminderEntry(
        ...
        "hereafter", "Sahih al-Bukhari 1417", ("fire", "charity"),
    ),
]